...
export default function Create() {
  ...
  <div className="row flex-nowrap">
    ...
    <Input  error={error}id={'password'} title={'user password'} type={'password'} customClass="bg-secondary" name={'password'} handelData={handelData}/>

 <div className='mb-3'>
 <input type="submit" className="form-control bg-body-secondary" value='Add User'/>
 </div>
